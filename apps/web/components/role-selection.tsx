...
import { ArrowRight, Bot, Building2, Globe, Shield, Zap } from "lucide-react";
				...
				{isAuthenticated && (
					<>
									...
									<div className="space-y-3">
										...
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Split payments automatically between multiple
													recipients
												</p>
											</div>
										</div>
									...
									<div className="space-y-3">
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Automatically handle payment requests instead of
													puzzles
												</p>
											</div>
										</div>
						...
						<div className="text-center">
							<p className="text-sm text-muted-foreground">
								Not sure which role fits you? You can always switch roles later
								in the dashboard.
							</p>
						</div>
					</>
